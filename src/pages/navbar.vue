...
<script>
export default {
  name: 'ComprehensiveQualityNavbar',
  data: () => {
    return {
      viewName: 'homeBox',
      navList: [{
        ...
        name: '首页',
        color: '#f9801a',
        id: '402812816c27eb13016c28155c820002',
        viewName: 'homeBox'
      }, {
        icon: 'icon-post',
        name: '学生信息',
        color: '#40C197',
        id: '40289e8b6c2177df016c22b162cf0007',
        viewName: 'stuinfoBox'
      }, {
        icon: 'icon-score',
        name: '班主任评语',
        color: '#38B3F1',
        id: '40289e8b6c1c68ce016c1c9951bf0002',
        viewName: 'commentBox'
      }, {
        icon: 'icon-training-experience',
        name: '记录汇总',
        color: '#FB4E02',
        ...
        name: '记录审核',
        color: '#FFD201',
        id: '40289e8b6c2177df016c22b0a4110006',
        viewName: 'printBox'
      }, {
        icon: 'icon-count',
        name: '数据统计',
